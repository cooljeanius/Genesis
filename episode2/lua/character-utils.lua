...
function wesnoth.wml_actions.add_hp(cfg)
    ...
    wesnoth.wml_actions.object { duration="forever", silent="yes", {"filter",{id=units[1].id}},{"effect",{apply_to="hitpoints",increase=hp,increase_total=hp}}}
    wesnoth.float_label(units[1].x,units[1].y, string.format("<span color='#008000'>+%d HP</span>",hp))
end
